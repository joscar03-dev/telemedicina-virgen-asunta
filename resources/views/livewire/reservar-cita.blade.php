<div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-md">
    <div class="flex items-center justify-between">
        ...
        <div class="flex-1">
            <img src="{{ asset('images/3.jpg') }}" alt="Imagen Izquierda" class="w-full h-full object-cover rounded-md">
        </div>
        ...
        <div class="flex-2 mx-4">
            ...
            @if ($paciente_id)
                ...
                <p class="text-gray-700">Paciente encontrado: <strong>{{ $nombre }} {{ $apellido }}</strong>
                </p>
            @else
                @if ($showPacienteForm)
            ...
            @if (!$showPacienteForm && $paciente_id)
                <form wire:submit.prevent="saveCita" class="mt-6 bg-gray-50 p-6 rounded-md shadow-md">
                    ...
                    <div class="mb-4">
                        <button wire:click="buscarMedicos"
                    ...
                    <div class="mb-4">
                        ...
                        @if (!$medicos || $medicos->isEmpty())
                            <span class="text-sm text-gray-500">No hay médicos disponibles para esta
                                especialidad.</span>
                        @endif
                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="fecha" wire:model="fecha"
                                ...
                                @foreach ($disponibilidades as $disponibilidad)
                                    <option value="{{ $disponibilidad->fecha }}">{{ $disponibilidad->fecha }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="time" id="hora" wire:model="hora"
                            class="mt-2 p-3 border border-gray-300 rounded w-full focus:ring-2 focus:ring-blue-500"
                            @if (!$fecha) disabled @endif>
                    </div>

                    <button type="submit"
                        class="mt-4 w-full bg-green-500 text-white py-3 rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500">
                        Reservar Cita
                    </button>
                </form>
            @endif
